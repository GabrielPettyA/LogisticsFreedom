...
if (in_array("gestion alarmas", $roles) && $totalAlarmas == 0) {
  echo '<li class="nav-item">
<a class="nav-link active" href="/tp2/alarmas-reposicion/">Gestión de alarmas</a>
</li>';
}

if (in_array("gestion alarmas", $roles) && $totalAlarmas > 0) {
  echo '<li class="nav-item">
<a class="nav-link active" href="/tp2/alarmas-reposicion/">
Gestión de alarmas
...
?>
  ...
  <script src="modAlarmas.js"></script>
</body>
